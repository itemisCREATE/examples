...
*/
extern void blinky_setTimer(Blinky* handle, const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic);
...
/*! 
	...
	\param evid An unique identifier of the event.
*/
extern void blinky_unsetTimer(Blinky* handle, const sc_eventid evid);
