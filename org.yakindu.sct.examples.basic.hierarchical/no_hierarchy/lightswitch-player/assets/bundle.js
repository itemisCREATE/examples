    ...
    (function (yakindu) {
        ...
        (function (io) {
            class Statemachine {
                ...
                microStep() {
                    switch ((this.stateVector[0])) {
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MOTIONDETECTED:
                            this.main_region_MotionDetected_react(-1);
                            break;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MOTIONDETECTIONMODE:
                            this.main_region_MotionDetectionMode_react(-1);
                            break;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_TWILIGHTDETECTIONMODE:
                            this.main_region_TwilightDetectionMode_react(-1);
                            break;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_TWILIGHTDETECTED:
                            this.main_region_TwilightDetected_react(-1);
                            break;
                ...
                isStateActive(state) {
                    switch ((state)) {
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MOTIONDETECTED:
                            return this.stateVector[0] === Statemachine.State.MAIN_REGION_MOTIONDETECTED;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MOTIONDETECTIONMODE:
                            return this.stateVector[0] === Statemachine.State.MAIN_REGION_MOTIONDETECTIONMODE;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_TWILIGHTDETECTIONMODE:
                            return this.stateVector[0] === Statemachine.State.MAIN_REGION_TWILIGHTDETECTIONMODE;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_TWILIGHTDETECTED:
                            return this.stateVector[0] === Statemachine.State.MAIN_REGION_TWILIGHTDETECTED;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MANUALMODE:
                ...
                enterSequence_main_region_MotionDetected_default() {
                    ...
                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_ENTERED, this, Statemachine.State.MAIN_REGION_MOTIONDETECTED, null, null)));
                    this.stateVector[0] = Statemachine.State.MAIN_REGION_MOTIONDETECTED;
                }
                enterSequence_main_region_MotionDetectionMode_default() {
                    this.entryAction_main_region_MotionDetectionMode();
                    ...
                    this.stateVector[0] = Statemachine.State.MAIN_REGION_MOTIONDETECTIONMODE;
                }
                enterSequence_main_region_TwilightDetectionMode_default() {
                    this.entryAction_main_region_TwilightDetectionMode();
                    ...
                    this.stateVector[0] = Statemachine.State.MAIN_REGION_TWILIGHTDETECTIONMODE;
                }
                enterSequence_main_region_TwilightDetected_default() {
                    this.entryAction_main_region_TwilightDetected();
                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_ENTERED, this, Statemachine.State.MAIN_REGION_TWILIGHTDETECTED, null, null)));
                    this.stateVector[0] = Statemachine.State.MAIN_REGION_TWILIGHTDETECTED;
                }
                ...
                exitSequence_main_region_MotionDetected() {
                    ...
                    this.exitAction_main_region_MotionDetected();
                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_EXITED, this, Statemachine.State.MAIN_REGION_MOTIONDETECTED, null, null)));
                }
                ...
                exitSequence_main_region_TwilightDetected() {
                    this.stateVector[0] = Statemachine.State.$NULLSTATE$;
                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_EXITED, this, Statemachine.State.MAIN_REGION_TWILIGHTDETECTED, null, null)));
                }
                ...
                exitSequence_main_region() {
                    switch ((this.stateVector[0])) {
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MOTIONDETECTED:
                            this.exitSequence_main_region_MotionDetected();
                            break;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MOTIONDETECTIONMODE:
                        ...
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_TWILIGHTDETECTIONMODE:
                            ...
                            break;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_TWILIGHTDETECTED:
                            this.exitSequence_main_region_TwilightDetected();
                            break;
                        case sct.yakindu.io.Statemachine.State.MAIN_REGION_MANUALMODE:
                ...
                main_region_MotionDetected_react(transitioned_before) {
                    let transitioned_after = transitioned_before;
                    if (transitioned_after < 0) {
                        if (this.timeEvents[0]) {
                            this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_MOTIONDETECTED, null, 0)));
                            this.exitSequence_main_region_MotionDetected();
                            this.timeEvents[0] = false;
                            this.enterSequence_main_region_MotionDetectionMode_default();
                            this.react(0);
                            ...
                            if (this.__user.on_button) {
                                this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_MOTIONDETECTED, null, 1)));
                                this.exitSequence_main_region_MotionDetected();
                                ...
                                if (this.__sensor.motion) {
                                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_MOTIONDETECTED, null, 2)));
                                    this.exitSequence_main_region_MotionDetected();
                                    this.enterSequence_main_region_MotionDetected_default();
                                    this.react(0);
                                    transitioned_after = 0;
                                }
                                else {
                                    if (this.__user.mode_button) {
                                        this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_MOTIONDETECTED, null, 3)));
                                        this.exitSequence_main_region_MotionDetected();
                    ...
                    if (transitioned_after < 0) {
                        if (this.__sensor.motion) {
                            ...
                            if (this.__user.on_button) {
                                ...
                                if (this.__user.mode_button) {
                                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_MOTIONDETECTIONMODE, null, 2)));
                                    this.exitSequence_main_region_MotionDetectionMode();
                                    this.enterSequence_main_region_TwilightDetectionMode_default();
                                    this.react(0);
                                    transitioned_after = 0;
                ...
                main_region_TwilightDetectionMode_react(transitioned_before) {
                    ...
                    if (transitioned_after < 0) {
                        if (this.__lum_sensor.dark) {
                            ...
                            this.exitSequence_main_region_TwilightDetectionMode();
                            this.enterSequence_main_region_TwilightDetected_default();
                            this.react(0);
                            transitioned_after = 0;
                        }
                        else {
                            if (this.__user.mode_button) {
                                ...
                                if (this.__user.on_button) {
                                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_TWILIGHTDETECTIONMODE, null, 2)));
                                    this.exitSequence_main_region_TwilightDetectionMode();
                                    this.enterSequence_main_region_ManualMode_default();
                                    this.react(0);
                                    transitioned_after = 0;
                ...
                main_region_TwilightDetected_react(transitioned_before) {
                    let transitioned_after = transitioned_before;
                    if (transitioned_after < 0) {
                        if (this.__lum_sensor.bright) {
                            this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_TWILIGHTDETECTED, null, 0)));
                            this.exitSequence_main_region_TwilightDetected();
                            this.enterSequence_main_region_TwilightDetectionMode_default();
                            this.react(0);
                            transitioned_after = 0;
                            ...
                            if (this.__user.mode_button) {
                                this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_TWILIGHTDETECTED, null, 1)));
                                this.exitSequence_main_region_TwilightDetected();
                                this.enterSequence_main_region_MotionDetectionMode_default();
                                this.react(0);
                                transitioned_after = 0;
                                ...
                                if (this.__user.on_button) {
                                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_REGION_TWILIGHTDETECTED, null, 2)));
                                    this.exitSequence_main_region_TwilightDetected();
                                    this.enterSequence_main_region_ManualMode_default();
                                    this.react(0);
                                    transitioned_after = 0;
            ...
            (function (Statemachine) {
                ...
                let State;
                (function (State) {
                    State[State["MAIN_REGION_MOTIONDETECTED"] = 0] = "MAIN_REGION_MOTIONDETECTED";
                    State[State["MAIN_REGION_MOTIONDETECTIONMODE"] = 1] = "MAIN_REGION_MOTIONDETECTIONMODE";
                    State[State["MAIN_REGION_TWILIGHTDETECTIONMODE"] = 2] = "MAIN_REGION_TWILIGHTDETECTIONMODE";
                    State[State["MAIN_REGION_TWILIGHTDETECTED"] = 3] = "MAIN_REGION_TWILIGHTDETECTED";
                    State[State["MAIN_REGION_MANUALMODE"] = 4] = "MAIN_REGION_MANUALMODE";
