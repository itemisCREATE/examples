        ...
        (function (io) {
            class Statemachine {
                ...
                runCycle() {
                    ...
                    } while (((this.switchEvent || this.changeBrightness)));
                    ...
                    if (transitioned_after < 0) {
                        if (this.switchEvent) {
                            ...
                            if (((this.changeBrightness) && (this.getBrightness() > 1))) {
                                this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_ON, null, 1)));
                                this.exitSequence_main_On();
                                ...
                                if (((this.changeBrightness) && (this.getBrightness() <= 1))) {
                                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.STATE_TRANSITION, this, Statemachine.State.MAIN_ON, null, 2)));
                                    this.exitSequence_main_On();
                                    this.setBrightness(10);
                                    this.trace.next((new com.yakindu.core.TraceEvent(com.yakindu.core.TraceEventType.VARIABLE_SET, this, null, Statemachine.Feature.BRIGHTNESS, this.brightness)));
                                    this.enterSequence_main_On_default();
            ...
            (function (Statemachine) {
                ...
                (function (Feature) {
                    ...
                    Feature[Feature["BRIGHTNESS"] = 3] = "BRIGHTNESS";
