...
/*! file/ Interface definition of a soft-timer service for YAKINDU SCT state machines. This timer can be used generically on any platform. It is driven by
 * an explicit call to its sc_timer_service_proceed function. */
...
/*! Proceeds the timer for the given time period in milliseconds.
 	All time events which are configured for this time period will be raised. The correct order of time events is preserved. */
