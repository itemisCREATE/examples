...
static void tictoc_event_init(tictoc_event * ev, tictoc_event_name name);
static sc_boolean tictoc_eventqueue_push(tictoc_eventqueue * eq, tictoc_event ev);
static void tictoc_add_event_to_queue(tictoc_eventqueue * eq, tictoc_event_name name);
...
static tictoc_event tictoc_eventqueue_pop(tictoc_eventqueue * eq)
{
	...
	if(tictoc_eventqueue_size(eq) <= 0) {
		tictoc_event_init(&event, tictoc_invalid_event);
	}
	else {
...
static tictoc_event tictoc_get_next_event(Tictoc* handle)
{
	...
	tictoc_event_init(&next_event, tictoc_invalid_event);
