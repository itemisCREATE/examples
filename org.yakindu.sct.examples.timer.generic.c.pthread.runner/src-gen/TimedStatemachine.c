...
static sc_boolean react(TimedStatemachine* handle, const sc_boolean try_transition);
static sc_boolean main_region_StateA_react(TimedStatemachine* handle, const sc_boolean try_transition);
static sc_boolean main_region_StateB_react(TimedStatemachine* handle, const sc_boolean try_transition);
...
static sc_boolean main_region_StateA_react(TimedStatemachine* handle, const sc_boolean try_transition) {
	...
	{ 
		...
		{ 
			if (handle->timeEvents.timedStatemachine_main_region_StateA_tev0_raised == bool_true)
			{ 
				exseq_main_region_StateA(handle);
...
static sc_boolean main_region_StateB_react(TimedStatemachine* handle, const sc_boolean try_transition) {
	...
	{ 
		if ((react(handle, try_transition)) == (bool_false))
		{ 
			if (handle->timeEvents.timedStatemachine_main_region_StateB_tev0_raised == bool_true)
			{ 
				exseq_main_region_StateB(handle);
				enseq_main_region_StateA_default(handle);
			}  else
