...
sc_ts_connection_t ts_connection[] =
		{
			...
			},
			{
				...
				.sm_callback = (sc_time_event_callback_fp) timedStatemachine2_raiseTimeEvent
			}
		};
...
extern void timedStatemachine_setTimer(TimedStatemachine* handle, const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic){
	sc_sw_timer_service_methods.start(&ts_connection[0], evid, time_ms, periodic);
}
...
extern void timedStatemachine2_setTimer(TimedStatemachine2* handle, const sc_eventid evid, const sc_integer time_ms, const sc_boolean periodic){
	sc_sw_timer_service_methods.start(&ts_connection[1], evid, time_ms, periodic);
}

extern void timedStatemachine2_unsetTimer(TimedStatemachine2* handle, const sc_eventid evid){
