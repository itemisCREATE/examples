...
/**
 * Created by dennisvandervlugt on 16.11.16.
 */
var infotainmentRoutes = [
...
export var YInfotainmentRoutingModule = (function () {
    function YInfotainmentRoutingModule() {
    }
    YInfotainmentRoutingModule = __decorate([
        NgModule({
            imports: [
    ...
    return YInfotainmentRoutingModule;
}());
